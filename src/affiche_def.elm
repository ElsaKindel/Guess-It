...
getDefinition mot =
  Http.get
    { url = "https://api.dictionnaryapi.dev/api/v2/entries/en/"++mot
...
view model =
    ...
    Init  {rows, nombre} ->
        div []
            [h1[] [text<|getDefinition<|fromJust<|myItem<|myArray<|model]
